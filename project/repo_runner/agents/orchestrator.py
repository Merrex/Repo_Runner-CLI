...
class Orchestrator:
    ...
    def _analyze_repository(self) -> Dict[str, Any]:
        ...
        # Use PortManagerAgent if services are detected
        if 'services' in detection_result and detection_result['services']:
            print("🔌 Configuring port management...")
            port_result = self.agents['port_manager'].get_port_configuration(detection_result['services'])
            detection_result['port_config'] = port_result
        
        return detection_result
    
    def _assess_environment(self) -> Dict[str, Any]:
        """Phase 2: Environment assessment and requirements analysis."""
    ...
    def _configure_services(self) -> Dict[str, Any]:
        """Phase 4: Service configuration and database setup."""
    ...
    def _start_services(self) -> Dict[str, Any]:
        """Phase 5: Intelligent service startup."""
        print("🚀 Starting services with dynamic port allocation...")
        
        # Use RunnerAgent for service startup
        runner_result = self.agents['runner'].start(self.checkpoint_results['repository_analysis'], self.workflow_state['mode'])
    ...
    def _optimize_system(self) -> Dict[str, Any]:
        """Phase 7: System optimization and final validation."""
    ...
    def _retry_service_startup(self) -> Dict[str, Any]:
        ...
        return self.agents['runner'].start(self.checkpoint_results['repository_analysis'], self.workflow_state['mode'])
